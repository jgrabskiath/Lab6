...
public class Place { 
  ...
  public String fetch() {
	...
	places.addmarker(city)
	markers=places.markers

    null
  }
  public String fetchmarker() {
	...
	Places places = elResolver.getValue(
              fc.getELContext(), null, "places");
              places.addmarker(markercity)
	markers=places.getmarkersList();
    mapUrls = ms.getMap(streetAddress, city, state,markers)
  ...
  public void zoomChanged(ValueChangeEvent e) {
   ...
   public void markeradded(ValueChangeEvent e) {
    String value = e.getComponent().getValue();
    markers.add(value)
  }
