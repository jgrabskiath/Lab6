...
public class MapService {
  private static final String APPID = "AIzaSyCDCuPjJd07cQdyc1dyP8rDOeS67q_q84o";
  ...
  public String[] getMap(String streetAddress, String city,
	      String state, String[] markers) {
	    String[] urls = new String[12];
	    boolean cannotAccessWebService = false;
	    
	    for (int i=1; i <= urls.length; ++i) {
	      String document = getMapDocumentFromWebService(
	          streetAddress, city, state, APPID, i,markers);
  ...
  private String getMapDocumentFromWebService(
    ...
    String url =
        "https://maps.googleapis.com/maps/api/staticmap?center="+city+"&zoom="+zoomLevel+"&size=300x300&markers=size:mid%7Ccolor:red%7C"+city+"&key=AIzaSyCDCuPjJd07cQdyc1dyP8rDOeS67q_q84o" ;
    return url;
  }
 
	  private String getMapDocumentFromWebService(
	      String streetAddress, String city, String state,
	      String appid, int zoomLevel,String[] markers) {
		  String mapmarkers="";
		  for (int i=1; i < markers.length; ++i) {
		      mapmarkers=mapmarkers+"%7C"+markers[i]+",";
		  }
	    String url =
	        "https://maps.googleapis.com/maps/api/staticmap?center="+city+"&zoom="+zoomLevel+"&size=300x300&markers=size:mid%7Ccolor:red%7C"+city+","+mapmarkers+"&key=AIzaSyCDCuPjJd07cQdyc1dyP8rDOeS67q_q84o" ;
	    return url;
	  }
